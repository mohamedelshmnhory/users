...
class AppFaker {
  ...
  static int randomInt(int max, {int min = 1}) => faker.randomGenerator.integer(max, min: min);
  ...
  static String get randomImage => 'https://picsum.photos/100/100?random=$randomId';
