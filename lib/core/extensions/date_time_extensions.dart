...
extension DateTimeExtended on DateTime {
  ...
  String toFormattedStringEEEdd() => DateFormat('EEE dd,').add_jm().format(this);
...
//data
  ...
  String toddMM() => DateFormat('dd - MM').format(this);

//View
  //String toFormattedStringMMMMY() => DateFormat('d MMM y', languageCode).format(this);

  String toUtcFormmatedString() => DateFormat('yyyy-MM-dd HH:mm:ss').format(toUtc());
