...
class NoConnection extends StatefulWidget {
  const NoConnection({Key? key, this.dismissible = true, this.retriable = true, required this.failure}) : super(key: key);
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              AppCloseButton(onPressed: () => dismiss(context: context, retry: false)),
              if (widget.retriable)
                const Image(
                  image: AssetImage(Assets.noWifi),
                  key: Key('no_connection_image_no_connection'),
                  height: 50,
              ...
              InkWell(
                ...
                child: Text(
                  widget.retriable ? 'no_connection' : 'Try again later',
                  style: const TextStyle(color: AppColors.darkGreyBlue, fontWeight: FontWeight.w600, height: 1.0, fontSize: 20),
                ),
              ),
              ...
              //     child: Text(
              //       widget.retriable ? 'check your connection' : errorCode,
              //       style: errorCode.isEmpty
              //           ? const TextStyle(color: AppColors.darkGreyBlue, fontWeight: FontWeight.w600, height: 1.0, fontSize: 16)
              //           : const TextStyle(color: AppColors.darkGreyBlue, fontWeight: FontWeight.w400, height: 1.5, fontSize: 14),
